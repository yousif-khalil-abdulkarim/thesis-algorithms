#include <stdlib.h>
#include "src/matrix/matrix-subtraction/matrix-subtraction.h";
...
i64** matrixSubtraction_int64_c(i64** matrixA, i64** matrixB, int height, int width) {
...
f64** matrixSubtraction_float64_c(f64** matrixA, f64** matrixB, int height, int width) {
...
f32** matrixSubtraction_float32_c(f32** matrixA, f32** matrixB, int height, int width) {
...
u32** matrixSubtraction_uint32_c(u32** matrixA, u32** matrixB, int height, int width) {
...
i32** matrixSubtraction_int32_c(i32** matrixA, i32** matrixB, int height, int width) {
...
u16** matrixSubtraction_uint16_c(u16** matrixA, u16** matrixB, int height, int width) {
...
i16** matrixSubtraction_int16_c(i16** matrixA, i16** matrixB, int height, int width) {
...
u8** matrixSubtraction_uint8_c(u8** matrixA, u8** matrixB, int height, int width) {
...
i8** matrixSubtraction_int8_c(i8** matrixA, i8** matrixB, int height, int width) {
