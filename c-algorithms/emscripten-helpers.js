...
* @return {CArray}
*/
function initArray(cArrayInit, malloc, heap, array) {
  const cArray = makeArray(cArrayInit, malloc, heap);
  setArray(cArray, heap, array);
  return cArray;
}
...
* @param {Malloc} malloc 
* @param {ArrayBuffer} heap 
* @param {ArrayLike<ArrayLike<number|bigint>>} array
* @return {CMatrix}
*/
function initMatrix(cMatrixInit, malloc, heap, array) {
  const cMatrix = makeMatrix(cMatrixInit, malloc, heap);
  setMatrix(cMatrix, heap, array);
  return cMatrix;
}
