export function matrixAddition_u64_js(
...
export function matrixAddition_i64_js(
...
export function matrixAddition_f64_js(
...
export function matrixAddition_f32_js(
...
export function matrixAddition_u32_js(
  matrixA: Uint32Array[],
  matrixB: Uint32Array[]
): Uint32Array[] {
  const width = matrixA[0].length;
...
export function matrixAddition_i32_js(
  matrixA: Int32Array[],
  matrixB: Int32Array[]
): Int32Array[] {
  const width = matrixA[0].length;
...
export function matrixAddition_u16_js(
  matrixA: Uint16Array[],
  matrixB: Uint16Array[]
): Uint16Array[] {
  const width = matrixA[0].length;
...
export function matrixAddition_i16_js(
  matrixA: Int16Array[],
  matrixB: Int16Array[]
): Int16Array[] {
  const width = matrixA[0].length;
...
export function matrixAddition_u8_js(
  matrixA: Uint8Array[],
  matrixB: Uint8Array[]
): Uint8Array[] {
  const width = matrixA[0].length;
...
export function matrixAddition_i8_js(
  matrixA: Int8Array[],
  matrixB: Int8Array[]
): Int8Array[] {
  const width = matrixA[0].length;
