export function matrixAddition_uint64_js(
...
export function matrixAddition_int64_js(
...
export function matrixAddition_float32_js(
...
export function matrixAddition_uint32_js(
  matrixA: Uint32Array[],
  matrixB: Uint32Array[]
): Uint32Array[] {
  const width = matrixA[0].length;
...
export function matrixAddition_int32_js(
  matrixA: Int32Array[],
  matrixB: Int32Array[]
): Int32Array[] {
  const width = matrixA[0].length;
...
export function matrixAddition_uint16_js(
  matrixA: Uint16Array[],
  matrixB: Uint16Array[]
): Uint16Array[] {
  const width = matrixA[0].length;
...
export function matrixAddition_int16_js(
  matrixA: Int16Array[],
  matrixB: Int16Array[]
): Int16Array[] {
  const width = matrixA[0].length;
...
export function matrixAddition_uint8_js(
  matrixA: Uint8Array[],
  matrixB: Uint8Array[]
): Uint8Array[] {
  const width = matrixA[0].length;
...
export function matrixAddition_int8_js(
  matrixA: Int8Array[],
  matrixB: Int8Array[]
): Int8Array[] {
  const width = matrixA[0].length;
