...
export function initArray1d_u64(array: ArrayLike<bigint>): number;
export function initArray1d_i64(array: ArrayLike<bigint>): number;
export function initArray1d_f64(array: ArrayLike<number>): number;
export function initArray1d_f32(array: ArrayLike<number>): number;
export function initArray1d_u32(array: ArrayLike<number>): number;
export function initArray1d_i32(array: ArrayLike<number>): number;
export function initArray1d_u16(array: ArrayLike<number>): number;
export function initArray1d_i16(array: ArrayLike<number>): number;
export function initArray1d_u8(array: ArrayLike<number>): number;
export function initArray1d_i8(array: ArrayLike<number>): number;

export function initMatrix_u64(array: ArrayLike<ArrayLike<bigint>>): number;
export function initMatrix_i64(array: ArrayLike<ArrayLike<bigint>>): number;
export function initMatrix_f64(array: ArrayLike<ArrayLike<number>>): number;
export function initMatrix_f32(array: ArrayLike<ArrayLike<number>>): number;
export function initMatrix_u32(array: ArrayLike<ArrayLike<number>>): number;
export function initMatrix_i32(array: ArrayLike<ArrayLike<number>>): number;
export function initMatrix_u16(array: ArrayLike<ArrayLike<number>>): number;
export function initMatrix_i16(array: ArrayLike<ArrayLike<number>>): number;
export function initMatrix_u8(array: ArrayLike<ArrayLike<number>>): number;
export function initMatrix_i8(array: ArrayLike<ArrayLike<number>>): number;
